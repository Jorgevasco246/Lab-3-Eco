  ...
  return (
    <div className="min-h-screen bg-green-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold text-green-600 mb-6 text-center">🏪 Registro Tienda</h2>
        {error && <p className="text-red-500 mb-4">{error}</p>}
        <input className="w-full border p-3 rounded-xl mb-3" placeholder="Tu nombre"
        ...
        <input className="w-full border p-3 rounded-xl mb-4" placeholder="Nombre de tu tienda"
